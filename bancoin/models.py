...
class User(db.Model, UserMixin):
    ...
    def get_condominium_id(self):
        home = Home.query.filter_by(id=self.home_id).one_or_none()
        return home.condominium_id
...
class Admin(User):
    ...
    def get_invitations(self):
        return [invitation.serialize for invitation in self.home.condominium.invitations]
